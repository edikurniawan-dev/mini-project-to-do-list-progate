...
export default function App() {
    ...
    return (
        <div className="px-3">
            <div className="max-w-4xl min-h-[85vh] px-5 pb-5 mx-auto mt-3 border shadow-lg md:mt-10 md:pb-10 md:px-10 card bg-base-100">
            ...
            <p className="flex justify-center text-center text-gray-500">
                Visit repository on&nbsp;
                <a
                    href="https://github.com/edikurniawan-dev/mini-project-to-do-list-progate"
